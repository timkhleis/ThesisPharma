# ============================================================================
# 11_run_robustness.R -- Run Main DiD v1 robustness Phase 1B only
# ============================================================================
...
message("\n", strrep("=", 76), "\nRunning Phase 1B design checkpoint: ", script,
        "\n", strrep("=", 76))
status <- system2(RSCRIPT, script)
if (!identical(status, 0L)) stop("Script failed: ", script, call. = FALSE)

message("\n11_run_robustness Phase 1B complete. Outcome estimation is intentionally not run.")
