...
source(file.path(BASE, "R", "archive", "main_did_v1", "11_main_design_utils.R"))   # banner, ebal_max_meandiff, model_matrix_cols, ess, standardize_continuous, smd_weighted, weight_quantile_diag
