...
similar (\(\StayerBufferedATT\), \(p=\StayerBufferedP\)), so late-sample
censoring does not explain the result. The governing deal-level interval just
includes zero, whereas the prominent two-way interval excludes zero.
